...
const {readCredentials, fetchBalance, testApiKey, saveCredentials, validateApiKey, validateApiSecret, closeAllOpenPositions} = require('./helper')
const bot = new Telegraf('6751006336:AAGntPSsKBFrDn0GDdN50vR85nnSLbAdTGQ'); // Replace with your token
