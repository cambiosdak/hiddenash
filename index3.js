...
const {readCredentials, fetchBalance, testApiKey, saveCredentials, validateApiKey, validateApiSecret, closeAllOpenPositions} = require('./helper3')
const bot = new Telegraf('6661256663:AAGZegu7xjmuSIqHaKRCneVOfzad3ITwPSo'); // Replace with your token
